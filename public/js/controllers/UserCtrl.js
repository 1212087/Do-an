...
.controller('ListUserController', ['$scope', 'User', '$mdDialog', function($scope, User, $mdDialog) {
...
.controller('ProfileUserController', ['appAlert', 'flash', 'Restangular', '$modal', '$scope', '$rootScope', '$http', '$state', '$stateParams', 'User', function(appAlert, flash, Restangular, $modal, $scope, $rootScope, $http, $state, $stateParams, User) {
    ...
    /*Đếm số tin mà thành viên này đã đăng*/
    User.countQuestion()
        .success(function(data) {

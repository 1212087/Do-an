...
module.exports = function (app, passport) {
    ...
    app.post('/api/question/create', function (req, res) {
        ...
        newQuestion.location = req.body.location;
        newQuestion.district = req.body.district;
        newQuestion.city = req.body.city;
        newQuestion.catalog = req.body.catalog;

        var tagg = req.body.tag;
    ...
    app.get('/api/question/getQuestionByDistrict/:district', function (req, res) {
        Question.find({
            district: req.params.district
        }).populate('district').exec(function (err, list) {
            if (err) {
                return res.send(err);
            }
            return res.json(list);
